...
class ListViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        waitingChatsListener = ListenerService.shared.waitingChatsObserve(chats: waitingChats,
...
extension ListViewController: WaitingChatNavigation {
    func removeWaitingChat(chat: MChat) {
        FirestoreService.shared.deleteWaitingChat(chat: chat) { (result) in
            switch result {
            case .success():
                self.showAlert(title: "Success!", and: "Chat with: \(chat.friendUsername) removed")
            case .failure(let error):
                self.showAlert(title: "Error!", and: error.localizedDescription)
            }
        }
    ...
    func chatToActive(chat: MChat) {
        ...
        FirestoreService.shared.changeToActive(chat: chat) { (result) in
            switch result {
            case .success:
                self.showAlert(title: "Success!", and: "Glag chatting with \(chat.friendUsername)")
            case .failure(let error):
                self.showAlert(title: "Error!", and: error.localizedDescription)
            }
        }
